 ...
 */
final class Version20240514171351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artista (id INT AUTO_INCREMENT NOT NULL, nombre_artistico VARCHAR(255) NOT NULL, ano_debut DATETIME NOT NULL, pais_origen VARCHAR(255) NOT NULL, biografia VARCHAR(500) NOT NULL, img_artista VARCHAR(500) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
